...
var an_account = new KinSdk.Account("GCEZWKCA5VLDNRLN3RPRJMRZOX3Z6G5CHCGSNFHEYVXM3XOJMDS674JZ", "46316927324160");

var transaction = new KinSdk.TransactionBuilder(an_account)
...
transaction.sign(KinSdk.Keypair.fromSecret(seedString)); // sign the transaction
...
* native `KIN` asset (`ASSET_TYPE_NATIVE`),
...
```js
var nativeAsset = KinSdk.Asset.native();
...
var testAsset = new KinSdk.Asset('TEST', 'GBBM6BKZPEHWYO3E3YKREDPQXMS4VK35YLNU7NFBRI26RAN7GI5POFBB');
...
var googleStockAsset = new KinSdk.Asset('US38259P7069', 'GBBM6BKZPEHWYO3E3YKREDPQXMS4VK35YLNU7NFBRI26RAN7GI5POFBB');
```
...
```js
KinSdk.Network.useTestNetwork();
var keypair = KinSdk.Keypair.fromSecret(secretString);

var source = new KinSdk.Account(keypair.publicKey(), "46316927324160");
var transaction = new KinSdk.TransactionBuilder(source)
  .addOperation(KinSdk.Operation.pathPayment({
      sendAsset: KinSdk.Asset.native(),
      sendMax: "1000",
      ...
      destAmount: "5.50",
      path: [
        new KinSdk.Asset('USD', 'GBBM6BKZPEHWYO3E3YKREDPQXMS4VK35YLNU7NFBRI26RAN7GI5POFBB'),
        new KinSdk.Asset('EUR', 'GDTNXRLOJD2YEBPKK7KCMR7J33AAG5VZXHAJTHIG736D6LVEFLLLKPDL')
      ]
  }))
  .build();
...
```js
KinSdk.Network.useTestNetwork();
var rootKeypair = KinSdk.Keypair.fromSecret("SBQWY3DNPFWGSZTFNV4WQZLBOJ2GQYLTMJSWK3TTMVQXEY3INFXGO52X")
var account = new KinSdk.Account(rootkeypair.publicKey(), "46316927324160");

var secondaryAddress = "GC6HHHS7SH7KNUAOBKVGT2QZIQLRB5UA7QAGLA3IROWPH4TN65UKNJPK";

var transaction = new KinSdk.TransactionBuilder(account)
  .addOperation(KinSdk.Operation.setOptions({
    signer: {
...
var secondKeypair = KinSdk.Keypair.fromSecret("SAMZUAAPLRUH62HH3XE7NVD6ZSMTWPWGM6DS4X47HLVRHEBKP4U2H5E7");
